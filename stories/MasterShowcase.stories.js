...
export default {
  title: 'Overview/Master Showcase',
  parameters: {
    docs: {
      description: {
        component: 'A comprehensive master showcase of all MyntUI components with modern Material Design 3 styling, demonstrating visual consistency and interaction patterns.',
      },
    },
    layout: 'fullscreen',
  },
...
// Master Showcase with enhanced visual design
export const MasterShowcase = () => {
...
MasterShowcase.parameters = {
  docs: {
    description: {
      story: 'A comprehensive master showcase displaying the full MyntUI component library with modern Material Design 3 styling, interactive demonstrations, and real-world usage examples.',
    },
  },
};