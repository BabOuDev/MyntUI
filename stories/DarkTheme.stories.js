...
export default {
  title: 'Theme/Dark Theme Support',
  parameters: {
    docs: {
      description: {
        component: 'Complete dark theme support for all components, demonstrating proper color scheme handling and theme switching.',
      },
    },
    backgrounds: {
      default: 'dark',
  ...
  decorators: [
    (Story) => {
      // Apply dark theme to the story
      const wrapper = document.createElement('div');
      wrapper.setAttribute('data-color-scheme', 'dark');
...
export const AllInputTypesDark = () => {
...
export const ComponentStatesInDark = () => {
  const container = document.createElement('div');
  container.innerHTML = `
    <style>
      [data-color-scheme="dark"] {
...
AllInputTypesDark.parameters = {
  docs: {
    description: {
      story: 'All 18 input types displayed in dark theme, showing proper color scheme handling and visibility.',
    },
  },
};

ComponentStatesInDark.parameters = {
  docs: {
    description: {
      story: 'Different component states (normal, disabled, error, focus) in dark theme to ensure proper contrast and accessibility.',
    },
  },
};