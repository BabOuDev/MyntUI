...
export default {
  title: 'Overview/Visual Enhancement Showcase',
  parameters: {
    docs: {
      description: {
        component: 'Enhanced visual showcase demonstrating the visual consistency, Material Design 3 compliance, and real-world component usage patterns of the MyntUI library with premium animations and interactions.',
      },
    },
    layout: 'fullscreen',
  },
...
export const VisualEnhancementShowcase = () => {
...
VisualEnhancementShowcase.parameters = {
  docs: {
    description: {
      story: 'Premium visual showcase demonstrating enhanced animations, interactions, and the polished user experience of the MyntUI component library. Features floating particles, shimmer effects, smooth transitions, and real-world component usage patterns.',
    },
  },
};