...
export default {
  title: 'Examples/Interactive Dashboard',
  parameters: {
    docs: {
      description: {
        component: 'A comprehensive interactive dashboard demonstrating real-world usage of MyntUI components in a modern application interface.',
      },
    },
    layout: 'fullscreen',
  },
...
FullDashboard.parameters = {
  docs: {
    description: {
      story: 'A comprehensive interactive dashboard demonstrating real-world usage of all MyntUI components in a modern application interface with live data, interactive controls, and responsive design.',
    },
  },
};