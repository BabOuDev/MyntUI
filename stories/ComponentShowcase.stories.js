...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'A comprehensive showcase of all MyntUI components demonstrating their capabilities and visual consistency.',
      },
    },
    layout: 'fullscreen',
  },
...
AllComponents.parameters = {
  docs: {
    description: {
      story: 'A comprehensive showcase displaying all MyntUI components with their variants, states, and usage examples.',
    },
  },
};
...
DesignSystem.parameters = {
  docs: {
    description: {
      story: 'Documentation of the design system tokens, including typography, spacing, colors, and elevation.',
    },
  },
};