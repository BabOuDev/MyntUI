...
localStorage.setItem('myntuiConfig', configJSON);
    ...
    <\/script>
  `,o};n.parameters={docs:{description:{story:"Interactive demonstration of the MyntUI global configuration system, showing how to control theme defaults, component settings, API object keys, and grid system integration."}}};var e,t,i;n.parameters={...n.parameters,docs:{...(e=n.parameters)==null?void 0:e.docs,source:{originalSource:`() => {
...
localStorage.setItem('myntuiConfig', configJSON);
  ...
  \`;
  return container;
}`,...(i=(t=n.parameters)==null?void 0:t.docs)==null?void 0:i.source}}};const k=["ConfigurationDemo"];export{n as ConfigurationDemo,k as __namedExportsOrder,w as default};
